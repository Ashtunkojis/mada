...
class OutfitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        [
            'master_id.min' => 'Please, select the Master'
        ]
        );
        ...
        $outfit->save();
        return redirect()->route('outfit.index')->with('success_message', 'New outfit was created.');
    }
    ...
    public function update(Request $request, Outfit $outfit)
    {
        ...
        $outfit->master_id = $request->master_id;
        $outfit->save();
        return redirect()->route('outfit.index')->with('success_message', 'The Outfit was edited.');
    }
    ...
    {
        $outfit->delete();
        return redirect()->route('outfit.index')->with('success_message', 'The Outfit was deleted.');
